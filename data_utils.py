...
from dep_parser_direct import DepInstanceParser
...
class RE_Processor():
    ...
    def read_features(self, data_dir, flag):
        ...
        for text_data,dep_info in zip(all_text_data, all_dep_info):
            ...
            e11_p = ori_sentence.index("<e1>")
            e12_p = ori_sentence.index("</e1>")
            e21_p = ori_sentence.index("<e2>")
            e22_p = ori_sentence.index("</e2>")
