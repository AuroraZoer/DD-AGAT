...
class DepInstanceParser():
    ...
    def get_first_order(self, direct=True):
    ...
    def get_second_order(self, direct=True):
    ...
    def get_third_order(self, direct=True):
    ...
    def get_dep_path(self, start_range, end_range, direct=True):
    ...
    def get_local_global_graph(self, start_range, end_range, direct=True):
        dep_path_adj_matrix, dep_path_type_matrix = self.get_init_dep_matrix()
    ...
    def get_global_graph(self, start_range, end_range, direct=True):
        dep_path_adj_matrix, dep_path_type_matrix = self.get_init_dep_matrix()
